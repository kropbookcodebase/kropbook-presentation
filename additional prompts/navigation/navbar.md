...
```bash
lucide-react, @radix-ui/react-slot, class-variance-authority, @radix-ui/react-icons, @radix-ui/react-navigation-menu, @radix-ui/react-popover, radix-ui, @radix-ui/react-dropdown-menu, @radix-ui/react-toggle, @radix-ui/react-select, @radix-ui/react-tooltip, @radix-ui/react-avatar, @radix-ui/react-scroll-area, @radix-ui/react-separator
```
